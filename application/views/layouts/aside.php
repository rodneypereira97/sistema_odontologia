                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="../../index2.html"><i class="fa fa-circle-o"></i> Dentistas</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../../index.html"><i class="fa fa-circle-o"></i> Reporte Citas</a></li>
                            <li><a href="<?php echo base_url();?>Reportes/Usuarios"><i class="fa fa-circle-o"></i> Reporte Usuarios</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
